...
* Releases shall be created frequently (according to spring or increment planning or even better automated via link:deployment-management.asciidoc#continuous-deployment[continuous-deployment]) from the mainline.
